...
write.csv(internal_val_results_df, "internal_validation12-14-all_vs_region1_corrected_missing_TimeRegion.csv")



boot_results<- manual_boot(source, target, 200, rep_formula)

write.csv(boot_results$apparent, "bootstrap_apparent_validation_results-all_vs_region1_corrected_missing_TimeRegion.csv")
write.csv(boot_results$test, "bootstrap_test_validation_results-all_vs_region1_corrected_missing_TimeRegion.csv")
